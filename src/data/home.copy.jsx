// ─────────────────────────────────────────────
//  HOME PAGE — copy & content
// ─────────────────────────────────────────────

export const heroContent = {
  eyebrow: "Ciao, sono Alex. Ti presento:",
  name: "Weboven,",
  tagline: "Esperienze digitali che lasciano il segno.",
  sub: "Non faccio siti web. Faccio strumenti che lavorano per te mentre dormi.",
  cta: {
    primary: { label: "Vedi cosa faccio", href: "/web" },
    secondary: { label: "Parliamoci", href: "/contatto" },
  },
};
...
export const servicesPreviewContent = {
  label: "cosa faccio",
  title: "Due aree. Un solo obiettivo.",
  items: [
    {
      id: "web",
...
export const numbersContent = {
  ...
  items: [
    ...
    { value: "3x", label: "ROI medio dei clienti" },
    { value: "100%", label: "Soddisfazione garantita" },
    { value: "0", label: "Progetti abbandonati a metà" },
  ],
};
